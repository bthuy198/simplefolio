...
<div class="container">
    ...
    <p><a href="/product?action=create" style="text-decoration: none; color: red">Create new product</a></p>
    <table class="table table-striped">
        ...
        <c:forEach var="p" items="${requestScope.products}">
            <tr>
                ...
                <td><img src="/images/${p.getImg()}" style="width: 100px; height: auto"></td>
                <td>${p.getPrice()}</td>
                <td>${p.getQuantity()}</td>
                ...
                <td>
                    ...
                    <a onclick="handleClick(${p.getProductId()})"><i class="fa-solid fa-trash"></i></a>
                </td>
            </tr>
        </c:forEach>
        </tbody>
