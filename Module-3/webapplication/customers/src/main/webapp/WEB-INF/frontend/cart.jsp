				...
				<div class="col-12">
					...
					<table class="table shopping-summery">
						...
						<c:forEach items="${requestScope.orderDTO.getOrderItemDTOS()}" var="orderItemDTO">
							<tr>
								<td class="image" data-title="No"><img src="/images/${orderItemDTO.getProduct().getImg()}" alt="#"></td>
								<td class="product-des" data-title="Description">
									<p class="product-name"><a href="#">${orderItemDTO.getProduct().getProductName()}</a></p>
									<p class="product-des">${orderItemDTO.getProduct().getDescription()}</p>
								</td>
								<td class="price" data-title="Price"><span>$${orderItemDTO.getProduct().getPrice()} </span></td>
								...
								<td class="total-amount" data-title="Total"><span>$${orderItemDTO.getTotal()}</span></td>
